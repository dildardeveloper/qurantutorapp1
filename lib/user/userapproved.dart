...
import 'package:qurantutorapp/user/useraproveddetail.dart';

class userapproved extends StatefulWidget {
  const userapproved({super.key});

  @override
  State<userapproved> createState() => _userapprovedState();
}
                              ...
                              ListTile(
                                onTap: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (context) => useraproveddetail(

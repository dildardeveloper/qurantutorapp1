...
class femaleperson_widget extends StatefulWidget {
  String firstName;
  String LastName;
  String imageurl;
  String teacherid;
  ...
  @override
  State<femaleperson_widget> createState() => _femaleperson_widgetState();
}

class _femaleperson_widgetState extends State<femaleperson_widget> {
  String category = '';
  String fph = '';
  String request = '';
  String addserviceid = '';
  ...
  Future<void> servicedata() async {
    ...
    setState(() {
      ...
      // request = serviceDic.get('request');

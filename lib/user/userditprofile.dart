...
class userditprofile extends StatefulWidget {
  final firstName;
  final LastName;
  final imageurl;
  final email;
  ...
  @override
  State<userditprofile> createState() => _userditprofileState();
}

class _userditprofileState extends State<userditprofile> {
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        TextFormField(
                          controller: language..text = widget.language,
                          obscureText: false,
                          decoration: InputDecoration(
                            hintStyle: TextStyle(
                              color: Color(0xff000000),
                  ...
                  task.whenComplete(() {
                    reference.getDownloadURL().then((imgurl) {
                      ...
                      FirebaseFirestore.instance
                        ...
                        displayMessage("user profile update");
                        Navigator.push(
                          context,
